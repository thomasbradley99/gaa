...
PRO_XML_DETECTABLE_10MIN = INPUT_DIR / "ground_truth_detectable_first_10min.xml"
...
# Try ground truth files in priority order (first 10 min detectable first)
if PRO_XML_DETECTABLE_10MIN.exists():
    PRO_XML_FILE = PRO_XML_DETECTABLE_10MIN  # First 10 min, detectable only (PRIORITY)
elif PRO_XML_FULL_GAME.exists():
