...
def resolve_assignment(profile: dict) -> str:
    ...
    if assignment not in {'team_a', 'team_b'}:
        ...
        print(f"      - If {profile['team_a']['jersey_color']} is home → set 'home_team_assignment': 'team_a'")
        print(f"      - If {profile['team_b']['jersey_color']} is home → set 'home_team_assignment': 'team_b'")
        print("")
