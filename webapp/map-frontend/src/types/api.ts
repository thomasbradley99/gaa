...
export interface paths {
    ...
    "/public/games": {
        ...
        /**
         * List public games
         * @description Retrieves a paginated list of public games that are accessible without authentication
         */
        get: operations["getPublicGames"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/public/games/{id}": {
         ...
         * @description Retrieves a specific public game by its ID. Only games marked as public are accessible.
         */
    ...
    "/public/videos/{id}": {
         ...
         * @description Retrieves a specific public video by its ID. Only videos marked as public are accessible.
         */
    ...
    "/public/videos/games/{gameId}": {
         ...
         * @description Retrieves a paginated list of public videos associated with a specific public game
         */
        get: operations["getPublicGameVideos"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    getVideoSignedUrl: {
        parameters: {
            query: {
                ...
                filename: string;
                /** @description Whether this video should be publicly accessible (uses 'public' instead of teamId in S3 key) */
                isPublic?: boolean;
            };
            header?: never;
            path: {
    ...
    getPublicGames: {
        ...
        requestBody?: never;
        responses: {
            /** @description Public games retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        /** @example Public games retrieved successfully */
                        message?: string;
                        /** @description Array of public games */
    ...
    getPublicGame: {
        ...
        requestBody?: never;
        responses: {
            /** @description Public game retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        /** @example Public game retrieved successfully */
                        message?: string;
                        data?: components["schemas"]["Game"];
                    };
                };
            };
            /** @description Public game not found */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getPublicVideo: {
        ...
        requestBody?: never;
        responses: {
            /** @description Public video retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        /** @example Public video retrieved successfully */
                        message?: string;
                        data?: components["schemas"]["Video"];
                    };
                };
            };
            /** @description Public video not found */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getPublicGameVideos: {
        ...
        requestBody?: never;
        responses: {
            /** @description Public game videos retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        /** @example Public game videos retrieved successfully */
                        message?: string;
                        /** @description Array of public videos for the game */
            ...
            /** @description Public game not found or has no public videos */
            404: {
                headers: {
                    [name: string]: unknown;
                };
