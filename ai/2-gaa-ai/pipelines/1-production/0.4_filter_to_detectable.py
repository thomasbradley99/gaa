...
in schema. Optionally filters by time range.

Usage:
    # Filter to first 10 mins detectable events
    python3 0.4_filter_to_detectable.py --game kilmeena-vs-cill-chomain --time-range 0-600
    
    # Filter to all detectable events (full game)
    python3 0.4_filter_to_detectable.py --game kilmeena-vs-cill-chomain --schema schema_gaa_all_events.json
    
    # Custom schema and time range
    python3 0.4_filter_to_detectable.py --game kilmeena-vs-cill-chomain --schema schema_gaa_all_events.json --time-range 0-600
"""
...
parser.add_argument('--schema', default='schema_gaa_all_events.json', help='Schema file to use for filtering')
...
parser.add_argument('--time-range', help='Time range to filter (e.g., "0-600" for first 10 mins)', default=None)
