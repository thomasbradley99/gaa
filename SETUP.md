...
### Map not showing
- Make sure `leaflet` and `react-leaflet` are installed: `cd frontend && npm install`
- Check browser console for errors
- Verify `gaapitchfinder_data.json` exists in `frontend/src/components/pitch-finder/`
